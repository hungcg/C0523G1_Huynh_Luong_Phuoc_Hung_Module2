...
public class Villa extends Facility {
    ...
    public Villa(int serviceID, String serviceName, double area, int price, int capacityOfRoom, String rentalType, String roomStandard, double poolArea, int quantityOfFloor) {
